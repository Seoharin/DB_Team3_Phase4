...
<body>
	...
	%>
	<input type = "submit" value = "마이페이지" onclick = "location.href = 'mypage.jsp'">
	<input type = "submit" value = "로그아웃" onclick = >
	
	<br>
	<input type = "submit" value = "제목으로 검색하기" onclick = "location.href = 'Titlesearch.jsp'" >
	<input type = "submit" value = "조건으로 검색하기" onclick = "location.href = 'Optionsearch.jsp'">
	<input type = "submit" value = "추천목록 보기" onclick = >
