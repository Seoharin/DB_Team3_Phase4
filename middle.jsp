...
<%
String title_id = request.getParameter("id");
...
%>
<br>
<input type="button" value="영상정보수정" onclick = "location.href = 'updatemovie.jsp'">
<input type="button" value="평가내역보기" onclick = "location.href = 'showrating.jsp'">
</form>
</body>
</html>